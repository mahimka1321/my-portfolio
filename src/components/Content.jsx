...
import DesignsList from "./DesignsList"; // Компонент сетки кнопок-проектов
import DesignDetail from "./DesignDetail"; // Компонент журнального кейса
import Skills from "./Skills"; // Компонент навыков и технологий
